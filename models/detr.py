...
class DETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        samples.tensors = self.pre_proj(samples.tensors)
        ...
        # The following is a no-go, can't modify inplace without messing up gradient computations.
        # outputs_coord[-1][:, :, 1] = 0.5
        # outputs_coord[-1][:, :, 3] = 1.0
...
def build(args):
    ...
    num_classes = 1  # 20 if args.dataset_file != "coco" else 91
